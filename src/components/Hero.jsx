...
const Hero = () => {
  return (
    <div className="text-center mx-16 my-16 w-1/5 relative">
      <figure className="rounded-full border bg-white h-28 w-28 overflow-hidden mx-auto mb-5">
      ...
      <div className="mb-9 flex justify-center items-center gap-2">
        ...
        <a href="https://www.linkedin.com/in/gilangcahyono" target="_blank">
          <svg
            className="w-7 h-7 text-gray-800 dark:text-white"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="flex justify-center gap-3">
        ...
        <a
          className="rounded-3xl text-sm px-5 py-1.5 bg-cyan-500 hover:outline hover:outline-1 hover:bg-transparent transition"
          href="#"
        >
          Download CV
        </a>
      </div>
      <p className="text-sm absolute -bottom-10 w-full text-center">
